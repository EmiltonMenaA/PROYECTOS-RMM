  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <main className="flex-1 overflow-auto">
        ...
        <div className="p-8">
          {isLoading && (
            <div className="bg-white rounded-xl shadow p-6 text-gray-600 mb-6">
              Cargando perfil...
            </div>
          )}
          {error && (
            ...
            <div className="bg-white rounded-xl shadow p-6 flex items-center gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500">
                  Sube una imagen de alta resolución para tu perfil corporativo. Formatos aceptados:
                  JPG, PNG o GIF.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <label className="flex items-center gap-3 text-sm text-gray-700">
                  <input
                    ...
                    onChange={e =>
                      setNotificationPrefs({ ...notificationPrefs, desktop: e.target.checked })
                    }
                    className="w-4 h-4 text-blue-600"
                  />
                ...
                <label className="flex items-center gap-3 text-sm text-gray-700">
                  <input
                    ...
                    onChange={e =>
                      setNotificationPrefs({ ...notificationPrefs, weekly: e.target.checked })
                    }
                    className="w-4 h-4 text-blue-600"
                  />
