...
export const authAPI = {
  ...
  deactivateUser: (userId, active) => api.patch(`/auth/${userId}/active`, { active }),
...
export const supervisorAPI = {
  getCalendar: (start, end) => api.get('/supervisor/calendar', { params: { start, end } }),

  createEvent: payload => api.post('/supervisor/events', payload),

  createTask: payload => api.post('/supervisor/tasks', payload),

  createAction: payload => api.post('/supervisor/actions', payload)
};
